...
mesh.show_animation(fig, axes, box, advance_backward, fname='advance_backward.mp4', frames=nt+1, lw=2, interval=50)
plt.show()
...
mesh.show_animation(fig, axes, box, advance_crank_nicholson,fname='advance_crank_nicholson.mp4', frames=nt + 1)
plt.show()
