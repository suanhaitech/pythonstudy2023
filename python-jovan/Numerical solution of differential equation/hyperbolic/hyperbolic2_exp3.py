...
#迎风格式带粘性项
def hyperbolic_operator_explicity_upwind_viscous(mesh, tau, a):
    """
    @brief 生成二维双曲方程的迎风格式的带粘性项迭代矩阵
...
def hyperbolic_windward_with_vicious(n, *fargs):
    """
    @brief 时间步进格式为Lax-Friedrichs 格式
    ...
    if n == 0:
        ...
        A = hyperbolic_operator_explicity_upwind_viscous(mesh,tau,a=1)
...
mesh.show_animation(fig, axes, box, hyperbolic_windward_with_vicious, plot_type='surface', frames=nt+1)
plt.show()
