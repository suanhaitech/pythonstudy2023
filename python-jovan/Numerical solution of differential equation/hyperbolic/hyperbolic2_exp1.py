...
def hyperbolic_operator_explicity_upwind(mesh, tau, a): 
    """
    @brief 二维双曲方程的显式迎风格式
    """
    rx = a*tau/mesh.h[0]
    ...
    if a > 0:
        ...
        B += csr_matrix((val, (J, I)), shape=(NN, NN), dtype=mesh.ftype)
...
def hyperbolic_windward(n, *fargs): # 点击这里查看 FEALPy 中的代码
    ...
    if n == 0:
        ...
        A = hyperbolic_operator_explicity_upwind(mesh,tau,a=1)
...
mesh.show_animation(fig, axes, box, hyperbolic_windward, plot_type='surface', frames=nt+1)
plt.show()
